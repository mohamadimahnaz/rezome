...
<head>
    <meta charset="UTF-8">
<title>رزومه علی ارجمند (طراح و توسعه دهنده وب)</title>
<meta name="description" content="علی ارجمند طراح و توسعه دهنده وب، Arjmand08" />
...
<meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <link href="https://cvbuilder.me/css/Online/hover.css" rel="stylesheet" />
        ...
        <div class="container-fluid ">
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-header navbar-expand-sm">
                    ...
                    <a class="navbar-brand" href="#">علی ارجمند </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left">
                            <li class="active"><a href="#about">درباره من</a></li>
                                                    ...
                                                    <li class=""><a href="#portfolio">سوابق شغلی</a></li>
                                                    <li class=""><a href="#language">زبان</a></li>
                                                    <li class=""><a href="#project">پروژه‌ها</a></li>
    ...
    <div class="container-fluid main_container rtl">
        <div class="content_inner_bg row m0">
            ...
            <section class="about_person_area pad " id="about">
                <div class="row">
                    <div class="col-md-3">
                        <div class="person_img">
                            <div class="user-image" style="background-image:url('Profile_Image.jpg');"></div>
                        </div>
                            <div class="social">

                                <ul class="contact1">
                                            <li>
                                                <a href="https://t.me/arjmand08" target="_blank"> <i class="fab fa-telegram"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://twitter.com/arjmand08" target="_blank"> <i class="fab fa-twitter"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://linkedin.com/in/arjmand08" target="_blank"> <i class="fab fa-linkedin"></i></a>
                                            </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class=" person_details ">
                            <h3 class="personname">علی ارجمند </h3>
                            <h4>
                            </h4>
                            <p>
                                من علی ارجمند 29ساله اهل لرستان،  برنامه نویسی رو با  HTML و CSS شروع کردم و بعد سراغ PHP و MySql رفتم و الان در آنها تخصص پیدا کردم و پروژه های متعددی رو در زمینه های مختلف انجام دادم . علاقه مند به پیشرفت کاری و یادگیری مهارت های خاص.
                            </p>
                                ...
                                <ul>
                                        <li>
                                            ...
                                            <a>لرستان، کوهدشت</a>
                                                                                                                                                   ...
                                                                                                                                                   <li>
                                          <a href="https://quera.ir/profile/arjmand08" target="_blank">صفحه من در وب سایت كوئرا</a>
                                        </li>

                                                                                                                                                    <li>
                                          <a href="resume_fa.pdf" target="_blank">دانلـــود رزومــه</a>
                                        </li>
                                </ul>
                            </div>
                ...
                <section class="education_area pad " id="education">
                    ...
                    <div class="education_inner_area " style="visibility : visible ; animation-name:fadeInUp">
                            ...
                            <div class="education_item wow fadeInUp animated" data-line="S">
                                <h3>کارشناسی ارشد مهندسی کامپیوتر</h3>
                                <h5>گرایش نرم افزار </h5>
                                            <h4 class="subtitle">دانشگاه: پیام نور واحد تهران شمال <label>پیام نور</label></h4>

                            </div>
                            <div class="education_item wow fadeInUp animated" data-line="S">
                                <h3>کارشناسی مهندسی کامپیوتر</h3>
                                <h5>گرایش نرم افزار </h5>
                                            <h4 class="subtitle">دانشگاه: موسسه آموزش عالی جهاددانشگاهی اصفهان <label>غیرانتفاعی</label></h4>

                            </div>
                            <div class="education_item wow fadeInUp animated" data-line="S">
                                <h3>کاردانی کامپیوتر</h3>
                                <h5>گرایش نرم افزار</h5>
                                            <h4 class="subtitle">دانشگاه: آموزشکده فنی و حرفه ای پسران بروجرد <label>دولتی</label></h4>
                ...
                <div class="bgimg" style="background-image:url(https://cvbuilder.me/images/exp-background.jpg);min-height:100%">
                    <section class="portfolio_area pad " id="portfolio">
                        ...
                        <div class="row">
                            <div class="portfolio_list_inner" style="position: relative; ">
                                        <div class="col-sm-12 col-md-4">
                                            <div class="portfolio_item">

                                                <div class="portfolio_title">
                                                    <span class="exprience-icon">
                                                        <i class="fa fa-check"></i>
                                                    </span>
                                                    <a><h4>کاربر رایانه</h4></a>
                                                    <h5>
سازمان/نهاد: کمیته امداد امام خمینی (ره)                                                     </h5>
                                                        <label class="date">خرداد ۱۳۸۷ - خرداد ۱۳۸۸</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4">
                                            <div class="portfolio_item">
                                                ...
                                                <div class="portfolio_title">
                                                    ...
                                                    <a><h4>کارشناس رایانه </h4></a>
                                                    <h5>
سازمان/نهاد: فرمانداری شهرستان کوهدشت                                                     </h5>
                                                        <label class="date">بهمن ۱۳۹۸ - اسفند ۱۳۹۸</label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-4">
                                            <div class="portfolio_item">
                                                ...
                                                <div class="portfolio_title">
                                                    ...
                                                    <a><h4>مسؤل انفورماتیک </h4></a>
                                                    <h5>
دانشگاه: غیر انتفاعی جویندگان علم                                                     </h5>
                                                </div>
                                            </div>
                                        </div>
...
<section class="myskill_area pad " id="language">
                    <div class="main_title">
                        <h2>زبان</h2>
                    </div>
                    <div class="row">
                                ...
                                <div class="col-md-6  wow fadeInUp  animated" style="visibility: visible; animation-name: fadeInUp;">
                                    <div class="skill_text">
                                        <a href="https://www.iribnews.ir/007KWB"  target="_blank"><h4>لَکی (زبان مــادری)</h4><h7>جهت مشاهده لطفا کلیک کنید</h7></a>
                                    </div>
                                    <div class="skill_item_inner">
                                        <div class="single_skill">
                                            <h4>مهارت خواندن</h4>
                ...
                </section>                      <section class="service_area " id="project">
                    <div class="main_title">
                        <h2>پروژه‌ها</h2>
                    </div>
                    <div class="row">
                        <div class="service_inner ">
                                <div class="col-md-6 ">
                                    <div class="service_item wow fadeIn animated" data-aos="flip-left" data-aos-duration="1500">
                                        <i class="fa fa-pencil-ruler" aria-hidden="true"></i>
                                        <a href="https://hekmat-giah.ir"  target="_blank"><h4>عنوان پروژه: وب سایت مجتمع خدمات درمانی حکمت گیاه</h4></a>
                                                                                    <label class="date">اسفند ۱۳۹۸</label>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12" data-aos="flip-right" data-aos-duration="1500">
                                    <div class="portfolio_item">
                                        <div class="portfolio_title hvr-underline-from-center">
                                            <a><h4 class=""> هفت گانه icdl</h4></a>
                                            <h5>مرکز آموزش فنی و حرفه ای شماره 3 لرستان</h5>
                                                <label class="date">مهر ۱۳۹۰</label>
                                        </div>
                                    </div>
                                </div>
                        </div>
...
<section class="portfolio_area pad " id="certificate">
                    ...
                    <div class="row ">
                        <div class="portfolio_list_inner" style="position: relative; height: 795.376px;">
                                <div class="col-md-6 col-sm-12" data-aos="flip-right" data-aos-duration="1500">
                                    <div class="portfolio_item">
                                        <div class="portfolio_title hvr-underline-from-center">
                                            <a><h4 class="">داریوش ارجمند</h4></a>
                                            <h5>فرهنگی بازنشسته ساکن اصفهان</h5>
                                            <h5>تلفن تماس : 09134135608</h5>
                                        </div>
                                    <div class="portfolio_title hvr-underline-from-center">
                                            <a><h4 class="">غلامحسین نورعلی</h4></a>
                                            <h5>فرهنگی بازنشسته ساکن لرستان</h5>
                                            <h5>تلفن تماس : 09166595009</h5>
                                        </div>
                                    </div>
                                </div>
                        </div>
                            ...
                            <div class="contact_from_area wow fadeInUp animated">
                                <div class="row">
                                    <form action="/fa/website/contact" method="post" id="contactForm">
                                        <input type="hidden" name="ReturnUrl" value="http://arjmand08.cvbuilder.me/fa" />
                                        <input type="hidden" name="SiteName" value="arjmand08" />
    ...
    <script src="https://cvbuilder.me/js/personal-web/Web1/wow.min.js"></script>
    <script src="https://cvbuilder.me/js/personal-web/web1-main.js"></script>
    <script>
